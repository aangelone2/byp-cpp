...
int main()
{
  ...
  test_exception<bool, iva>("invalid_bool_1",
                            "read '1' while expecting bool",
                            parser);
  test_exception<bool, iva>("invalid_bool_2",
  ...
  test_exception<int, iva>("invalid_sign",
                           "read '1+4' while expecting int",
                           parser);

  cout << "  Testing double sign for int..." << endl;
  test_exception<int, iva>("double_sign",
  ...
  test_exception<size_t, iva>(
      "scientific", "read '1e+6' while expecting size_t",
      parser);
  ...
  test_exception<double, iva>(
      "invalid_for_double",
      "read 'ilm' while expecting double", parser);
